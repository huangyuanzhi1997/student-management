    ...
    <tr>
      <td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="709" align="center" valign="top" background="Images/guangxian.png">&nbsp;<h1>欢迎使用学生管理系统</h1>
    
         
   <!--  <div t style="padding:50px;overflow:hidden; color:red; " >
	<p style="font-size: 25px; line-height: 30px; height: 30px;"></p>
  	<p>开发人员：huang</p>
  	<p>开发周期：2019/6/15 --- 2018/6/22（共计7天）</p>
  	<hr />
  	<h2>系统环境</h2>
  	<p>系统环境：Windows</p>
	<p>开发工具：Eclipse</p>
	...
	<p>服务器：Tomcat 7.0</p>
	<p>数据库：MySQL 5.0</p>
	<p>系统采用技术： Spring+SpringMVC+Mybatis+Bootstrap+Jquery</p>
</div> -->
